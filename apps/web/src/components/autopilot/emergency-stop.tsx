  ...
  return (
    <div className="space-y-2">
      <button
        ...
        disabled={executing}
        className="relative overflow-hidden flex items-center justify-center gap-2 w-full bg-apple-red/20 hover:bg-apple-red/30 text-apple-red border border-apple-red/30 rounded-xl px-6 py-3 text-sm font-semibold transition-all ease-spring disabled:opacity-50 select-none"
      >
        {executing ? (
          <>
